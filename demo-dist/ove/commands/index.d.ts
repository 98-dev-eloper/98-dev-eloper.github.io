...
export namespace commandDefs {
    ...
    namespace findPrimerBindingSites {
        let name_10: string;
        ...
        export function handler_25(props: any): void;
    ...
    namespace changeCircularityCmd {
        export function isHidden_14(p: any): any;
        export { isHidden_14 as isHidden };
        export { noop as handler };
    }
    namespace cut {
        export function isDisabled_9(props: any): any;
        export { isDisabled_9 as isDisabled };
        export function isHidden_15(props: any): any;
    ...
    namespace createNewFromSubsequence {
        export function name_12(props: any): "Create New AA Sequence From Selection" | "Create New Oligo From Selection" | "Create New DNA Sequence From Selection";
        export { name_12 as name };
        export function isDisabled_10(props: any): boolean;
        export { isDisabled_10 as isDisabled };
        export function isHidden_16(props: any): boolean;
        export { isHidden_16 as isHidden };
        export function handler_29(props: any): void;
        export { handler_29 as handler };
    }
    namespace copy {
        export function isDisabled_11(props: any): boolean;
    ...
    namespace redo {
        ...
        export function isDisabled_14(props: any): any;
        export { isDisabled_14 as isDisabled };
        export function handler_33(props: any): any;
    ...
    namespace print {
        export namespace hotkeyProps_7 {
    ...
    namespace limitsMenu {
        export function isHidden_39(props: any): any;
    ...
    namespace showChromQualScoresMenu {
        export function isHidden_40(props: any): boolean;
        export { isHidden_40 as isHidden };
    }
